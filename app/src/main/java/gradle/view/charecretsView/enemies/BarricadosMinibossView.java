...
public class BarricadosMinibossView extends EnemyView{
     public static final List<View> items = new ArrayList<>();
    public static final List<View> removedItems = new ArrayList<>();

    public BarricadosMinibossView(String Id, EnemyType enemyType) {
        super(Id, enemyType);
    ...
    public void draw(Graphics g, Component component) {
        ...
        Image necro = new ImageIcon("app/src/main/java/gradle/assets/images/barricados.png").getImage();
